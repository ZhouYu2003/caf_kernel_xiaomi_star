...
KERNEL_NAME=ZhouYu2003Kernel-star-"$DATE"
...
echo "=========================Build========================="
make -j$(nproc) O=out CC="ccache clang" CXX="ccache clang++" CROSS_COMPILE=$CLANG_PATH/bin/aarch64-linux-gnu- CROSS_COMPILE_ARM32=$CLANG_PATH/bin/arm-linux-gnueabi- LD=ld.lld star_defconfig
